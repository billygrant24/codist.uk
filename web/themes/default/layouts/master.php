...
<head>
    ...
    <title><?= $this->section('title') ?> – <?= $siteTitle ?></title>
    <!-- Bootstrap Core CSS -->
    <link href="<?= $themeDir ?>/assets/css/bootstrap.min.css" rel="stylesheet">
    <!-- Custom CSS -->
    <link rel="stylesheet" href="//cdnjs.cloudflare.com/ajax/libs/highlight.js/8.4/styles/default.min.css">
    <link href="<?= $themeDir ?>/assets/css/clean-blog.css" rel="stylesheet">
    <!-- Custom Fonts -->
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                ...
                <p class="copyright text-muted">Copyright &copy; 2015 William Grant-Buckley.</p>
            </div>
        </div>
    </div>
</footer>
...
<script src="<?= $themeDir ?>/assets/js/clean-blog.min.js"></script>
